...
export interface SSEStreamProps<Output> {
  /**
...
type SSEReadableStream<R = SSEOutput> = ReadableStream<R> & AsyncGenerator<R>;
 ...
 */
function SSEStream<Output = SSEOutput>(options: SSEStreamProps<Output>) {
